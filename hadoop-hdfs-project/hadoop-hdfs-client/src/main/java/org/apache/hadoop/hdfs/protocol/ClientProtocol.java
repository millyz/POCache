...
public interface ClientProtocol {
  ...
  // POCache added - Client reports the performance of each DataNode to ParityCacheManager
  //void reportPerfToPcm(List<String> dnIDs, List<Double> perfs) throws IOException;

  // POCache added - Client reports the straggler DataNode to ParityCacheManager
  //void reportSlowDNsToPcm(List<String> slowDNs, List<String> normalDNs) throws IOException;
  
  // POCache added
  void reportCompleteRead(long fileId, String slowDataNode) throws IOException;
  /**
