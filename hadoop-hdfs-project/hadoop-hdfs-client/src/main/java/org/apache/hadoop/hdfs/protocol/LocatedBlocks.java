...
public class LocatedBlocks {
  ...
  private ParityCacheInfo pcInfo; // POCache added on Dec. 12, 2017
  ...
  public LocatedBlocks(long flength, boolean isUnderConstuction,
    ...
    this.pcInfo = null; //POCache added
  }
  ...
  public LocatedBlocks(long flength, boolean isUnderConstuction,
      List<LocatedBlock> blks, LocatedBlock lastBlock,
      boolean isLastBlockCompleted, FileEncryptionInfo feInfo,
      ErasureCodingPolicy ecPolicy, ParityCacheInfo pcInfo) {
    fileLength = flength;
    blocks = blks;
    underConstruction = isUnderConstuction;
    this.lastLocatedBlock = lastBlock;
  ...
  /**
   * Set parity cache info.
   * POCache added on Sep. 17, 2018
   */
  public void setPcInfo(ParityCacheInfo pcInfo) {
    this.pcInfo = pcInfo;
  }
  /**
   * Get located blocks.
  ...
  public ParityCacheInfo getParityCacheInfo() { return pcInfo; }
