...
import static org.apache.hadoop.hdfs.client.HdfsClientConfigKeys.PcacheRead;
...
public class DfsClientConf {
  ...
  // POCache added
  private final int pcacheReadPolicy;
  private final long pcacheReadThresholdMillis;
  private final int pcacheReadThreadpoolSize;
  private final int datNum;
  private final int parNum;
  private final long subblkSize;
  private final int numThreadsWriteSubblk;
  ...
  public DfsClientConf(Configuration conf) {
    ...
    // POCache added
    pcacheReadPolicy = conf.getInt(
            PcacheRead.POLICY_ID,
            PcacheRead.POLICY_DEFAULT);
    pcacheReadThresholdMillis = conf.getLong(
        PcacheRead.THRESHOLD_MILLIS_KEY,
        PcacheRead.THRESHOLD_MILLIS_DEFAULT);
    pcacheReadThreadpoolSize = conf.getInt(
        HdfsClientConfigKeys.PcacheRead.THREADPOOL_SIZE_KEY,
        HdfsClientConfigKeys.PcacheRead.THREADPOOL_SIZE_DEFAULT);
    datNum = conf.getInt(
            HdfsClientConfigKeys.PcacheRead.NUM_DAT_KEY,
            HdfsClientConfigKeys.PcacheRead.NUM_DAT_DEFAULT);
    parNum = conf.getInt(
            HdfsClientConfigKeys.PcacheRead.NUM_PAR_KEY,
            HdfsClientConfigKeys.PcacheRead.NUM_PAR_DEFAULT);
    subblkSize = conf.getLong(
            PcacheRead.SUBBLK_SIZE_KEY,
            PcacheRead.SUBBLK_SIZE_DEFAULT);
    numThreadsWriteSubblk = conf.getInt(
            PcacheRead.NUM_THREADS_WRITE_SUBBLK_KEY,
            PcacheRead.NUM_THREADS_WRITE_SUBBLK_DEFAULT);
    redisIp = conf.get(
            HdfsClientConfigKeys.DFS_PCACHE_REDIS_IP,
  ...
  // POCache added
  /**
   * @return the pcacheReadPolicy
   */
  public int getPcacheReadPolicy() {
    return pcacheReadPolicy;
  }

  /**
   * @return the pcacheReadThresholdMillis
   */
  public long getPcacheReadThresholdMillis() {
    return pcacheReadThresholdMillis;
  }

  /**
   * @return the pcacheReadThreadpoolSize
   */
  public int getPcacheReadThreadpoolSize() {
    return pcacheReadThreadpoolSize;
  }

  /**
   * @return the datNum
   */
  public int getDatNum() { return datNum; }

  /**
   * @return the parNum
   */
  public int getParNum() { return parNum; }

  /**
   * @return the subblkSize
   */
  public long getSubblkSize() { return subblkSize; }

  /**
   * @return the numThreadsWriteSubblk
   */
  public int getNumThreadsWriteSubblk() { return numThreadsWriteSubblk; }
