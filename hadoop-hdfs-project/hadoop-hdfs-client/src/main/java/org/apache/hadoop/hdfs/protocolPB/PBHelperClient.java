...
// POCache added
import org.apache.hadoop.hdfs.protocol.ParityCacheInfo;
/* */
...
// POCache added
import org.apache.hadoop.hdfs.protocol.proto.HdfsProtos.ParityCacheInfoProto;
/* */
...
public class PBHelperClient {
  ...
  public static LocatedBlocks convert(LocatedBlocksProto lb) {
    return new LocatedBlocks(
        ...
        lb.hasPcInfo() ? convertParityCacheInfo(lb.getPcInfo()) : null); // POCache added
  }
  ...
  public static LocatedBlocksProto convert(LocatedBlocks lb) {
    ...
    // POCache added on Dec. 12, 2017
    if (lb.getParityCacheInfo() != null) {
      builder.setPcInfo(convertParityCacheInfo(
            lb.getParityCacheInfo()));
    }
  ...
  // POCache added on Dec. 12, 2017
  public static ParityCacheInfo convertParityCacheInfo(
      ParityCacheInfoProto proto) {
    return new ParityCacheInfo(proto.getDatNumPcache(),
        proto.getParNumPcache(),
        proto.getCodeType(),
        proto.getIsDone(),
        proto.getPending(),
        proto.getParNumPcacheNew(),
        proto.getSlowDNsPossibleList());
  }

  // POCache added on Dec. 12, 2017
  public static ParityCacheInfoProto convertParityCacheInfo(
      ParityCacheInfo info) {
    ParityCacheInfoProto.Builder builder = ParityCacheInfoProto
      .newBuilder()
      .setDatNumPcache(info.getDatNumPcache())
      .setParNumPcache(info.getParNumPcache())
      .setCodeType(info.getCodeType())
      .setIsDone(info.getIsDone())
      .setPending(info.getPending())
      .setParNumPcacheNew(info.getParNumPcacheNew())
      .addAllSlowDNsPossible(info.getSlowDNsPossible());
    return builder.build();
  }
