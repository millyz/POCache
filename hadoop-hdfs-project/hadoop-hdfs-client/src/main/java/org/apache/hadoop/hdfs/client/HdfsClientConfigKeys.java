...
public interface HdfsClientConfigKeys {
  ...
  String DFS_PCACHE_ON_KEY = "dfs.pcache.read.on";
  boolean DFS_PCACHE_ON_DEFAULT = false;
  String DFS_HEDGED_ON_KEY = "dfs.hedged.read.on";
  boolean DFS_HEDGED_ON_DEFAULT = false;
  // POCache added on Nov. 13, 2018
  ...
  // POCache added
  /** dfs.client.pcache.read configuration properties */
  interface PcacheRead {
    String PREFIX = HdfsClientConfigKeys.PREFIX + "pcache.read.";
    String POLICY_ID = PREFIX + "policy";
    int POLICY_DEFAULT = 1;
    String  THRESHOLD_MILLIS_KEY = PREFIX + "threshold.millis";
    long    THRESHOLD_MILLIS_DEFAULT = 500;
    String  THREADPOOL_SIZE_KEY = PREFIX + "threadpool.size";
    int     THREADPOOL_SIZE_DEFAULT = 0;
    String SUBBLK_SIZE_KEY = PREFIX + "subblk.size";
    long SUBBLK_SIZE_DEFAULT = 1 * 1024 * 1024;
    String NUM_THREADS_WRITE_SUBBLK_KEY = PREFIX + "num.threads.write.subblk";
    int NUM_THREADS_WRITE_SUBBLK_DEFAULT = 10;
    String CACHE_SIZE_KEY = PREFIX + "cache.size";
    int CACHE_SIZE_DEFAULT = 100;
    String CACHE_ALG_KEY = PREFIX + "cache.alg";
    int CACHE_ALG_DEFAULT = 1;
    String NUM_DAT_KEY = PREFIX + "dat.num";
