...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  //public void reportPerfToPcm(List<String> dnIDs, List<Double> perfs) throws IOException {
    //ReportPerfToPcmRequestProto.Builder builder = ReportPerfToPcmRequestProto.newBuilder();
    //builder.addAllDnIDs(dnIDs);
    //builder.addAllPerfs(perfs);
    //ReportPerfToPcmRequestProto req = builder.build();
    //try {
      //rpcProxy.reportPerfToPcm(null, req);
      //return ;
    //} catch (ServiceException e) {
      //throw ProtobufHelper.getRemoteException(e);
    //}
  //}
  //public void reportSlowDNsToPcm(List<String> slowDNs, List<String> normalDNs) throws IOException {
    //ReportSlowDNsToPcmRequestProto.Builder builder = ReportSlowDNsToPcmRequestProto.newBuilder();
    //builder.addAllSlowDNs(slowDNs);
    //builder.addAllNormalDNs(normalDNs);
    //ReportSlowDNsToPcmRequestProto req = builder.build();
    //try {
      //rpcProxy.reportSlowDNsToPcm(null, req);
      //return;
    //} catch (ServiceException e) {
      //throw ProtobufHelper.getRemoteException(e);
    //}
  ...
  public void reportCompleteRead(long fileId, String slowDataNode)
      throws IOException {
    ReportCompleteReadRequestProto.Builder builder = 
      ReportCompleteReadRequestProto.newBuilder();
    builder.setFileId(fileId);
    builder.setSlowDataNode(slowDataNode);
    ReportCompleteReadRequestProto req = builder.build();
    try {
      rpcProxy.reportCompleteRead(null, req);
      return ;
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  ...
  public HdfsFileStatus create(String src, FsPermission masked,
    ...
    builder.setParityCacheOn(parityCacheOn);
