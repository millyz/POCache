...
//  protected abstract void doEncodeUpdate(ByteBufferEncodingState encodingState);

  //// POCache added on Mar. 5, 2018
  //public void encode(byte[][] inputs, byte[][] outpus, int vecIdx) {
  ...
  //// POCache added on Mar. 5, 2018
  //public void encode(ECChunk[] inputs, ECChunk[] outputs, int vecIdx) {
    //ByteBuffer[] newInputs = ECChunk.toBuffers(inputs);
    //ByteBuffer[] newOutputs = ECChunk.toBuffers(outputs);
    //encode(newInputs, newOutputs, vecIdx);
  //}
