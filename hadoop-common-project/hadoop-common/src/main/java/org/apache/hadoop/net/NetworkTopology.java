...
public class NetworkTopology {
  ...
  private static final Random r = new Random(123);//POCache added on Apr. 6, 2018
  private int leaveIndexLast = -1;// POCache added - record the last leaveIndex to do round robin placement
  ...
  private Node chooseRandom(final InnerNode parentNode,
    ...
    if (excludedNodes == null || excludedNodes.isEmpty()) {
      ...
      // POCache added - change to round robin
      final int index = (leaveIndexLast + 1) % totalInScopeNodes;
      leaveIndexLast = index;
