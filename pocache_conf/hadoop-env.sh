...
export HADOOP_HOME="/home/potato/hadoop-3.1.1"
export HADOOP_YARN_HOME="/home/potato/hadoop-3.1.1"
export HADOOP_MAPRED_HOME="/home/potato/hadoop-3.1.1"
...
# POCache redirect the terminal output into files
#export HADOOP_ROOT_LOGGER=INFO,DRFA

# Default log4j setting for daemons spawned explicitly by
# --daemon option of hadoop, hdfs, mapred and yarn command.
# Java property: hadoop.root.logger
export HADOOP_DAEMON_ROOT_LOGGER=INFO,DRFA
